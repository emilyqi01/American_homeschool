...
special_theme = theme(
  ...
  legend.margin = margin(t = 20, r = 0, b = 0, l = -135, unit = "pt"),
...
plots = ggplot(school_state, aes(x = year, y = homeschool_students, group = Abbreviation))+
  ...
  scale_x_discrete(limits = years_to_include, expand = c(0, 0))+
...
ggsave("../output/state.png",plots,width = 160/40, height = 165/40,dpi = 300, units = "in")
